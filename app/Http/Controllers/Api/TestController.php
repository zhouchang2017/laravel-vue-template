...
class TestController extends Controller
{
    ...
    {
//        $routers = API::router()->getRoutes('v1');
//         $res = (collect($routers->getRoutes())->map(function($item, $key){
//             return [$item->methods()[0] => $item->getName()];
//         }));
//         return $res;
        $ref = new \ReflectionClass(__CLASS__);
        $classDoc = $ref->getDocComment();
        dd($this->parse($classDoc));
//        $module = $this->getModule($classDoc);
    }
