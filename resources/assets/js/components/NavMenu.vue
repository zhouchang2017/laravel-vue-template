        ...
        items: [
          {
            ...
            items: [
              {title: 'fba入库',route: {name: 'FulfillmentInboundShipment.Index'}},
              {title: 'CreateInboundShipmentPlan',route: {name: 'FulfillmentInboundShipment.CreateInboundShipmentPlan'}},
